  ...
  return (
    <div className="bg-gray-800 p-3 flex justify-between  text-white sticky top-0 z-50 ">
      <div className="flex gap-5  ">
        ...
        <h3>
          {" "}
          <span className="text-3xl font-bold"><span className="text-4xl font-bold text-red-700">N</span>aukari-Pao</span>
          <br />{" "}
          <span className="text-gray-400 font-extrabold border-b">
      ...
      <div className=" space-x-5 mt-2  ">
        ...
        <Link
          to={"/login"}
          className=" bg-amber-600 hover:text-amber-300 hover:border-2 px-5 pb-2 ms-100 rounded-3xl"
        >
          Login
        </Link>
        <Link
