        ...
        <form>
          <div className="text-white flex gap-25 pt-25 px-25 ">
           ...
           {/* ___________________________________________________________________ */}
                                <div className="mt-30 text-white flex gap-35 pb-15 ms-20 mx-30 border-b border-gray-700">
                                  <span className="flex gap-5  ">
                                    <img src={pic} alt=""  className="rounded-4xl h-10  " />
                                    <h3 > <span className="text-2xl font-bold"> Naukari-Pao </span><br /> <span className="text-gray-400 font-extralight border-b"><i>Pao Sapno ki naukari</i> </span></h3>
                    
                                  </span>
                                  <span className="text-xl">
                                    <span className="text-3xl">5000+</span> Talented Hunter
                                  </span>
                                  <span className="text-xl">
                                    <span className="text-3xl"> 451 </span> Talented Hunter
                                  </span>
                                  <span className="text-xl">
                                    <span className="text-3xl">568</span> Talented Hunter
                                  </span>
                                </div>
                                {/* ____________________________________________ */}
                                <div className=" flex justify-between text-gray-500 mx-30 pb-10 ">
                                <span className="flex gap-2  mt-10">
                                  Copyright ©2025 All rights reserved | This template is made with{" "}
                                  <FaHeart className="text-red-800  mt-1 text-xl" /> by{" "}
                                  <i>Arpit Gupta</i>
                                </span>
                                <span className="flex gap-5  text-2xl mt-10">
                                   <a href="www.facebook.in"> <FaFacebookF  className="hover:text-red-700"/></a>
                                   <a href=""> <FaTwitter  className="hover:text-red-700"/></a>
                                    <a href=""><AiOutlineGlobal  className="hover:text-red-700"/></a>
                                   <a href=""> <FaBehance  className="hover:text-red-700"/></a>
                                   </span>
