  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="bg-gray-400 w-375 h-250 pt-15 text-white rounded-2xl ">
          <div className="text-center">
        ...
        <footer className="bg-black py-10 px-30">
          <form>
            ...
            <div className="mt-30 text-white flex gap-35 pb-15  border-b border-gray-700">
              <span className="flex gap-5  ">
                <img src={pic} alt="" width={50} className="rounded-4xl  " />
                <h3 > <span className="text-3xl font-bold"> Naukari-Pao </span><br /> <span className="text-gray-400 border-b"><i>Pao Sapno ki naukari</i> </span></h3>
